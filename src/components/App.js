...
class App extends Component {
  ...
  sortHogs = (filteredHogs) => filteredHogs.sort((hogA, hogB) => {
    ...
    if(this.state.sortType === 'weight') {
      return hogB['weight as a ratio of hog to LG - 24.7 Cu. Ft. French Door Refrigerator with Thru-the-Door Ice and Water'] - hogA['weight as a ratio of hog to LG - 24.7 Cu. Ft. French Door Refrigerator with Thru-the-Door Ice and Water']
    }
